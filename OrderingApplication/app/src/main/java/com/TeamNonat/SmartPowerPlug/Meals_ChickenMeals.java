...
public class Meals_ChickenMeals extends Fragment implements OnClickListener
{
    private final String ProductName = "ProductName";
    private final String Description = "Description";
    private final String Price = "Price";

    private static final String url = AppController.serveraddress+"/query/ChickenMeals.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pageTitle.setText("Chicken Meals");
        ...
        pDialog.setMessage("Loading Chicken Meals..");
