...
public class Meals_Desserts extends Fragment implements OnClickListener
{
    private final String ProductName = "ProductName";
    private final String Description = "Description";
    private final String Price = "Price";

    private static final String url = AppController.serveraddress+"/query/Desserts.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pDialog.setMessage("Loading Desserts...");
