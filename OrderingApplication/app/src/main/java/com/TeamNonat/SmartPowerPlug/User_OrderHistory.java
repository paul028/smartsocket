...
{
    View myView;
    private static final String url = AppController.serveraddress+"/query/viewOrderHistory.php";
    String username;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.orderhistory_layout,container,false);

        listView = (ListView) myView.findViewById(R.id.orderhistoryLV);
